...
const fetchMessages = function(messageGroup) {
  return (messageGroup && groupedMessages[messageGroup]) || [];
};

const clear = function(messageGroup) {
  messageGroup &&
    groupedMessages[messageGroup] &&
    delete groupedMessages[messageGroup];
};

const flush = function(messageGroup) {
  var messages = fetchMessages(messageGroup);
  clear(messageGroup);
  return messages;
};

const add = function(messageGroup, message) {
  if (messageGroup) {
...
const count = function(messageGroup) {
